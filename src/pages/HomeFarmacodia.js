  ...
  return (
    <body>
      ...
      <main>
        ...
        {/* Seccion Sobre la pagina de depresao de burgos asociada */}
        <div className="border-depresao">
          <section className="depresao-t">
            <h2 className="depresao-c">Consulta mas sobre temas como:</h2>
            <div class="container-item">
              <div class="item">Estres</div>
              <div class="item">Depresion</div>
              <div class="item">Indicios De Depresion</div>
            </div>
            {/* Boton para mandar a la pagina de burgos */}
            <button className="boton-depresao visita-depresao">
              Visita Depresao
              <FontAwesomeIcon
                className="visita-img"
                icon={faArrowRight}
                style={{ color: "#41277c" }}
              />
            </button>

            {/* Seccion que explica lo que es brevemente la pagina de burgos */}
            <div className="es-div">
              <img className="es-img" src={depresao}></img>
              <div className="es0">
                <span className="es">
                  ¿Que es <span className="es1">Depresao?</span>
                </span>
              </div>
              <p className="es2">
                {" "}
                Lorem inpsum harem situm yutem fasute itume jukemu sabedum sotem
                jutem sodem.
              </p>
              <p className="es3">
                En depresao podras obtener informacion sobre depresion, ansiedad
                y temas relacionados con estos,
                <br />
                al igual que podras hacer un test el cual te dira si tienes
                indicios de estos <br />o alguno de tus seres queridos cercanos
                pueda padecerlos, y otras cosas mas.
              </p>
            </div>
            {/*Seccion para las tarjetas con la informacion de la pagina de burgos */}
            <div className="tarjetas-depresao">
              {/* Tarjeta 1 */}
              <div className="card1-depresao">
                <h3 className="card1-titulo">Informacion De Confianza</h3>
                <p className="card1-text">
                  Consulta sobre temas relacionados <br />
                  con tu salud mental, depresion, <br />
                  ansiedad y muchos otros.
                </p>
              </div>
              {/*Tarjeta 2 */}
              <div className="card2-depresao">
                <h3 className="card2-titulo">Test relacionados</h3>
                <p className="card2-text">
                  Podras realizar test para verificar <br />
                  si es que sospechas si tienes alguna de estas <br />
                  ya mencionadas (depresion, ansiedad,etc).
                </p>
              </div>
              {/* Tarjeta 3 */}
              <div className="card3-depresao">
                <h3 className="card3-titulo">Consejos especializados</h3>
                <p className="card3-text">
                  Podras ver consejos para resolver <br />
                  o ayudarte con estos problemas <br />a ti o a personas que
                  conozcan que tengan.
                </p>
              </div>
            </div>
            {/* Seccion que explica como funciona el test de la pagina de burgos */}
            <div className="">
              <h2 className="test-titulo">¿Como Funciona El Test?</h2>
              {/* 1er Paso */}
              <div className="test-uno">
                <span className="test-1-titulo">1</span>
                <span className="test-1-text">
                  {" "}
                  Ingresar a link o boton de el test,
                  <br /> al ingresar se te pediran y documentaran los datos
                  necesarios{" "}
                </span>
              </div>
              {/* 2Do Paso */}
              <div className="test-dos">
                <span className="test-2-titulo">2</span>
                <span className="test-2-text">
                  al estar en la pantalla de el test deberas contestar de manera
                  sincera <br /> debes de contestar cadauna de las preguntas
                  para poder darse un resultado <br />
                </span>
              </div>
              {/*3Er paso */}
              <div className="test-tres">
                <span className="test-3-titulo">3</span>
                <span className="test-3-text">
                  Al teminar el test deberas presionar el boton de terminado
                  para obtener un resultado a base de tus respuestas <br /> Con
                  el resultado podras saber que tipos de ayuda y podrias tener
              ...
              {/* Mensaje sobre casos urgentes */}
              <div className="casos">
                <h2 className="casos-titulo">No Descuides Tu Mente</h2>
                <p className="casos-text-1">
                  Si crees que tu problemas es grave
                  <br />
                  visita un especialista de urgencia.
                </p>
                <p className="casos-text-2">
                  Recuerda que tu salud es lo primero <br />
                  ante todo lo demas.
                </p>
              </div>
            </div>
